...
- Starting state: each player spawns with exactly **800 coins**, `0 crystals`, and profile from auth/JWT.
...
- Server starts with empty player-owned world (no pre-placed buildings in current iteration).
